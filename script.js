...
/*section 2 CODE*/
    ...
    td.innerText = 'B.E E&C';
    tr.append(td);
    td = document.createElement('td');
    td.innerText = '2016';
    tr.append(td);
    td = document.createElement('td');
    td.innerText = 'VTU University';
    tr.append(td);
    td = document.createElement('td');
    td.innerText = '70';
    tr.append(td);
    ...
    tr.append(td);
    td = document.createElement('td');
    td.innerText = 'KARNATAKA STATE BOARD';
    tr.append(td);
    td = document.createElement('td');
    td.innerText = '83';
    tr.append(td);
...
/*header*/
    ...
    let h2 = document.createElement('h2'); h2.innerText = 'TOufik Desai';
    header2.append(h2);
    ...
    p = document.createElement('p');p.innerText = 'Passionate Programmer | Web Developer -  toufik.desai12@gmail.com';
    header4.append(p);
